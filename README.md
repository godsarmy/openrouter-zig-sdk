...
The SDK covers chat completions, streaming, Messages, Responses, embeddings, rerank, audio, video, files, presets, model/provider discovery, usage metadata, datasets, analytics, and management APIs.
