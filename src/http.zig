...
fn buildHeaders(
    ...
    try appendHeader(allocator, &headers, "User-Agent", "openrouter-zig/0.4.0-dev");
...
test "prepare request adds required and optional headers" {
    ...
    try std.testing.expectEqualStrings("openrouter-zig/0.4.0-dev", findHeader(prepared.headers, "user-agent").?);
